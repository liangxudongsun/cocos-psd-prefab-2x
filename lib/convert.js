...
function strokePng(id, c, stroke) {
    ...
    return { buf: PNG.sync.write(png), width: W, height: H };
}
...
async function convert(opts) {
    ...
    const report = { ignored: [], images: [], reused: 0, revalidated: 0, trimmed: 0, flattened: 0, mergedDecor: 0, written: 0, nodes: 0, labels: 0, strokeBaked: 0, strokeSkipped: [], prefab: null };
